...
(function(){
  ...
  if(!isValidSession(sess, 'jescri')){
    const next = encodeURIComponent(window.location.pathname || '/clientes/jescri/');
    window.location.replace(`/area-do-cliente/?next=${next}`);
    return;
  }

  // -----------------------------
  // topo + menu do cliente (injetado para manter consistência em /clientes/jescri/*)
  // -----------------------------
          ...
          <div class="container">
            ...
            <div class="clientPanels" aria-label="subitens">
              <div class="clientPanel" data-panel="retrospectiva" aria-hidden="true">
                ...
                <a href="/clientes/jescri/retrospectiva/historico.html">histórico</a>
              </div>

              <div class="clientPanel" data-panel="relatorios" aria-hidden="true">
                <a href="/clientes/jescri/relatorios/trimestral.html">trimestral</a>
              ...
              <div class="clientPanel" data-panel="calendario" aria-hidden="true">
                <a href="/clientes/jescri/calendario/">semestral</a>
                <a href="/clientes/jescri/calendario/fevereiro.html">fevereiro</a>
                <a href="/clientes/jescri/calendario/marco.html">março</a>
                <a href="/clientes/jescri/calendario/abril.html">abril</a>
              </div>
              ...
              <div class="clientPanel" data-panel="influencia" aria-hidden="true">
                <a href="/clientes/jescri/influencia/ativacoes-do-mes/">ativações do mês</a>
              </div>
              ...
              <div class="clientPanel" data-panel="alinhamento" aria-hidden="true">
                <a href="/clientes/jescri/alinhamento/">formulário semestral</a>
                <a href="/clientes/jescri/alinhamento/historico.html">histórico</a>
              </div>
            </div>
          </div>
        </div>
